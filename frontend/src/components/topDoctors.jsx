...
const TopDoctors = () => {
  ...
  return (
      ...
      <div className="flex flex-col items-center gap-4 my-16 text-gray-900md:mx-10">
        ...
        <button className="bg-blue-50 px-8 py-3 rounded-full cursor-pointer mt-10 transition-all duration-200 hover:font-semibold" onClick={() => {navigate('/doctors'); scrollTo(0,0)}}>View All</button>
      </div>
