...
const AddDoctor = () => {
  ...
  const onSubmitHandler = async (e) => {
    e.preventDefault() //it will not reload the webpage on submit
  ...
  return (
    <form onSubmit={onSubmitHandler}  action="" className='m-5 w-full'>
      ...
      <div className='bg-white px-8 py-8 border border-[#E1E1E1] rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        ...
        <div className='flex items-center gap-4 mb-8 text-gray-500'>
          <label htmlFor="doc-img">
            ...
            {/* creates a temperory url for the image yusing createobjecturl */}
          </label>
